...
abstract class _AuthResponse implements AuthResponse {
  const factory _AuthResponse(
      ...
      final String? message,
      final UserData? data}) = _$AuthResponseImpl;
...
class _$UserDataImpl extends _UserData {
  ...
  @override
  String toString() {
    return 'UserData(id: $id, token: $token, role: $role, name: $name, phone: $phone, email: $email)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, token, role, name, phone, email);
